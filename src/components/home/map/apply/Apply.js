...
class Apply extends React.Component{
    ...
    <Row>
      ...
      Accept
            ...
            <div>
            <button className="btn btn-danger" onClick={this.rejectPayment.bind(this, this.props.apply.jobId, this.props.apply.employeeId)}>
      Reject
    </button>
            </div>
        </Col>
        :<Col xs={4}>
            <h4>{this.props.apply.status.toUpperCase()}</h4>
        </Col>
    }
    </Row>
    :null}
